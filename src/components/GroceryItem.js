...
// Conditional statement: if ingredient array is populated, generate a find items button
      ...
      return (
        <div style={{display: 'flex', justifyContent: 'center'}}>
          {this.props.items.length >= 1 &&
            ...
            <Button variant="outline-green" onClick={this.handleSubmit}>Click to find items</Button>
          }  
        </div>
      )
    }
  ...
  getRecipe = () => {
    ...
    return   axios(`https://api.spoonacular.com/food/products/search?query=${recipeString}&apiKey=5c87fc7501454e29ad5a56bb45d581bd&number=20`)
      .then((response)=>{
